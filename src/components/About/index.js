...
import Work from '../../assets/Jorg-work-2.gif'
    ...
    return (
        <div id="about">
            ...
            <Swiper
                ...
                spaceBetween={30}
                slidesPerGroup={window.screen.width < 800 ? 1 : 2}
                loop={true}
            ...
            >
                ...
                <SwiperSlide>
                    <div className="img-box">
                    <img className="foto-P" src={PDF} alt="Foto" />
                    </div>
                ...
                <SwiperSlide>
                    <div className="img-box">
                    <img className="foto-C" src={Certificado} alt="Foto" />
                    </div>
                ...
                <SwiperSlide>
                    <div className="img-box">
                    <img className="foto" src={Work} alt="Foto" />
                    </div>
